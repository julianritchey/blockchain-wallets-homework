...
def send_transaction(w3, account, to, wage):
    ...
    raw_tx = {
        ...
        "value": value,
        "gas": gasEstimate,
        # NOTE: The original "gasPrice" was set to "0". This value threw the value error "Transaction's maxFeePerGas (0) is less than the block's baseFeePerGas (875000000)". I, therefore, have adjusted the "gasPrice" to a value larger than the block's baseFeePerGas.
        "gasPrice": 2000000000,
